...
public class LvlWorld extends MyWorld
{
    ...
    public LvlWorld(int lvlType, boolean reset)
    {
        ...
        {
            int choice =  Greenfoot.getRandomNumber(4) + 3;
            for (int i = 0 ; i < choice ; i ++) 
            {
                int random = Greenfoot.getRandomNumber(8) + 1;
        ...
        setPaintOrder(Transition.class,Player.class,Display.class,Enemy.class,Torch.class,Skull.class, Block.class, ShieldDisplay.class  );
    }
